...
class WavenumberSpectrogramLS:
    ...
    def cal_spectrogram(self, x = None, data=None, error=None, name=None, xlims =None, weight_data= True, max_nfev = None, map_func=None):
        ...
        #  derive L2 stancil
        self.stancil_iter = create_chunk_boundaries(L, self.xlims, ov= self.ov, iter_flag=True)
    ...
    def mean_spectral_error(self, mask=None, confidence = 0.95 ):
        return WavenumberSpectrogram.mean_spectral_error(self, mask=mask, confidence= confidence )
