...
def add_info(D, Dk, ylims):
    ...
    plt.text(
        ...
        ylims[-1],
        "  N="
        + numtostr(N_per_stancil)
        + " N/2M= "
        + fltostr(N_per_stancil / 2 / ksize, 1),
    )
...
for i in xpp:
    ...
    for k in all_beams:
        ...
        # oringial data
        eta_1 = plot_data_eta(
            Gx_1, offset=offs, linestyle="-", c="k", linewidth=1, alpha=0.5, zorder=11
        )
    ...
    for k in all_beams:
        ...
        # oringial data
        eta_1 = plot_data_eta(
            Gx_1, offset=offs, linestyle="-", c="k", linewidth=1.5, alpha=0.5, zorder=11
        )
